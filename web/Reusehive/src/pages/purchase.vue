<template>
  ...
  <t-image style="position: absolute;z-index: -1;margin-top: 15vh;margin-left: 12vw" src="https://iconfont.alicdn.com/auth/illus/file/uROzvnLLp3G9/e4b8fb0e-396d-4954-a52f-7c845aed63c3_origin.svg?auth_key=1713875400-0-0-8cfc0d5f7b01d81a28f5e499acb34075">
  </t-image>
  <t-list style="max-height: 85vh;overflow: auto;background-color: white;background-color: rgba(255,255,255,0.35)">
    <div v-for="info in List" style="margin-top: 15px; margin-bottom: 15px;display: flex" @click="godetail(info.itemId,info.id)">
      <t-image style="width: 72px; height: 72px;" :src="info.imageurl" fit="fill"></t-image>
