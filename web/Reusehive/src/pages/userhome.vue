<template>
  <div class="profile-container">
      ...
      <t-grid-item text="订单">
        <template #image>
          <div class="icon-wrapper" style="background-color: transparent">
            <svg class="icon" height="32" p-id="9360" t="1713140051274" version="1.1"
                 viewBox="0 0 1024 1024" width="32" xmlns="http://www.w3.org/2000/svg">
              <path
                  d="M711.9872 219.0848c0.2048 2.7136 0.4096 5.4784 0.4096 8.2432v2.9184c0 53.8624-42.496 97.4848-94.9248 97.4848H474.6752c-52.4288 0-94.9248-43.6224-94.9248-97.4848v-2.9184c0-2.7648 0.2048-5.5296 0.4096-8.2432-96.512 9.216-172.0832 92.5696-172.0832 194.0992v347.4432c0 107.6736 84.992 194.9696 189.8496 194.9696h296.2432c104.8576 0 189.8496-87.296 189.8496-194.9696V413.184c0-101.5296-75.52-184.8832-172.032-194.0992z"
                  fill="#FFF7E6" p-id="9361"></path>
              <path
                  d="M884.0192 495.6672c-14.1312 0-25.6-11.4688-25.6-25.6v-22.3744c0-14.1312 11.4688-25.6 25.6-25.6s25.6 11.4688 25.6 25.6v22.3744c0 14.1824-11.4176 25.6-25.6 25.6zM668.6208 508.4672H342.272c-14.1312 0-25.6-11.4688-25.6-25.6s11.4688-25.6 25.6-25.6h326.3488c14.1312 0 25.6 11.4688 25.6 25.6s-11.4688 25.6-25.6 25.6zM668.6208 707.7376H342.272c-14.1312 0-25.6-11.4688-25.6-25.6s11.4688-25.6 25.6-25.6h326.3488c14.1312 0 25.6 11.4688 25.6 25.6s-11.4688 25.6-25.6 25.6z"
                  fill="#44454A" p-id="9362"></path>
              <path
                  d="M589.6192 271.7184H422.3488c-56.576 0-102.4-45.824-102.4-102.4v-10.7008c0-56.576 45.824-102.4 102.4-102.4h167.2704c56.576 0 102.4 45.824 102.4 102.4v10.7008c0 56.576-45.8752 102.4-102.4 102.4z"
                  fill="#FD973F" p-id="9363"></path>
              <path
    ...
    <t-cell-group bordered>
      <t-cell arrow hover title="我的出售"/>
      <t-cell arrow hover title="个人信息" @click="goinfo"/>
      <t-cell arrow hover title="设置">
      </t-cell>
      <t-cell hover title="显示ip">
        <template #note>
          <t-switch :default-value="true"/>
        </template>
      </t-cell>
      <t-cell arrow hover note="关于软件" title="其他"/>
      <t-cell :left-icon="lockIcon" arrow hover title="单行标题"/>
